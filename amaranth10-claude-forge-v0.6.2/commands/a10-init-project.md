...
2. **초기화 유형 결정** (AskUserQuestion 활용)
   ...
   - **새 프로젝트 등록**: `_projects/`에 새 PRJ 파일을 생성
...
3. `_projects/_dashboard.md`에서 최신 PRJ ID를 확인하고 다음 순번을 채번한다.
4. `_projects/_templates/project-detail.md`를 복사하여 `PRJ-YYYY-NNN_{프로젝트명}.md`로 생성한다.
5. 사용자에게 필수 정보를 확인한다:
